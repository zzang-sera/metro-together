// src/screens/route/Line2RouteScreen.js
...
export default function Line2RouteScreen() {
  const route = useRoute();
  const { stationName = "을지로입구", type = "EV", imageUrl = null } = route.params || {};
  ...
  return (
    <View style={s.container}>
      <Text style={s.header}>
        {stationName} - {getTypeLabel(type)} 좌표 등록 (2호선)
      </Text>
