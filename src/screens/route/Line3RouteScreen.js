// src/screens/route/Line3RouteScreen.js
...
export default function Line3RouteScreen() {
  const route = useRoute();
  const { stationName = "교대", type = "EV", imageUrl = null } = route.params || {};
  ...
  return (
    <View style={s.container}>
      <Text style={s.header}>
        {stationName} - {getTypeLabel(type)} 좌표 등록 (3호선)
      </Text>
