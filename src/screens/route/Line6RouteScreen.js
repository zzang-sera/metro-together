// src/screens/route/Line6RouteScreen.js
...
export default function Line6RouteScreen() {
  const route = useRoute();
  const { stationName = "합정", type = "EV", imageUrl = null } = route.params || {};
  ...
  return (
    <View style={s.container}>
      <Text style={s.header}>
        {stationName} - {getTypeLabel(type)} 좌표 등록 (6호선)
      </Text>
